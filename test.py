...
class Tester:
    ...
    def process_dir(self, output, img_dir, mask_dir):
        ...
        imgs_path = sorted(list(img_dir.glob("*.jpg")) +
                           list(img_dir.glob("*.png")))
        masks_path = sorted(list(mask_dir.glob("*.jpg")) +
    ...
    def inpaint(self, output, img, mask, merge_result=False):
        ...
        self.prepare_folders(
            [self.sub_dir("result"), self.sub_dir(
                "alpha"), self.sub_dir("raw")]
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output", default="./output/places2", help="Output dir")
    parser.add_argument(
        "--merge",
        action="store_true",
